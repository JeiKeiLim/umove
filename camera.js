...
import {DoSomeWorkout} from "./workout"

const videoWidth = 600;
const videoHeight = 500;
const stats = new Stats();

const doSomeWorkout = new DoSomeWorkout(videoWidth, videoHeight);
...
function detectPoseInRealTime(video, net) {
  ...
  async function poseDetectionFrame() {
    ...
    doSomeWorkout.arriveKeypoints(poses, minPoseConfidence, minPartConfidence);
